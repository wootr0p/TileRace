// LevelResultsCoop.cpp — co-op mode end-of-level results screen.
// Extracted from the original Renderer::DrawResultsScreen.
...
void DrawLevelResultsModeCoop(Font& font_hud, Font& font_timer,
    ...
    DrawTextEx(font_timer, r_title, {rcx - r_tsz.x * 0.5f, 40.f}, 48, 1, r_tcol);
