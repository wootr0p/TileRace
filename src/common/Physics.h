...
inline constexpr float MOVE_SPEED  = 400.f;    // px / secondo (velocità massima orizzontale)
...
// --- Fisica (passo 5) ---
inline constexpr float GRAVITY        = 2000.f; // px / s²   — da bilanciare ai playtest
inline constexpr float JUMP_FORCE     = 1000.f; // impulso verticale verso l'alto
inline constexpr float MAX_FALL_SPEED = 1400.f; // velocità massima in caduta
